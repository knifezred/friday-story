declare namespace NaiveUI {
  ...
  type TableColumnCheck = import('@renderer/packages/hooks').TableColumnCheck
  type TableDataWithIndex<T> = import('@renderer/packages/hooks').TableDataWithIndex<T>
  type FlatResponseData<T> = import('@renderer/packages/axios').FlatResponseData<T>
  ...
  type NaiveTableConfig<A extends TableApiFn> = Pick<
    import('@renderer/packages/hooks').TableConfig<
      A,
      GetTableData<A>,
